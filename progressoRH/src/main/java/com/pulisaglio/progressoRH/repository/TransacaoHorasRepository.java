...
public class TransacaoHorasRepository {
    ...
    private static final RowMapper<TransacaoHoras> ROW_MAPPER = new RowMapper<>() {
        @Override
        public TransacaoHoras mapRow(ResultSet rs, int rowNum) throws SQLException {
            TransacaoHoras t = new TransacaoHoras();
            t.setIdTransacao(rs.getLong("id_transacao"));
            t.setDataReferencia(rs.getDate("data_referencia").toLocalDate());
    ...
    public void save(TransacaoHoras transacao) {
        final String sql = "INSERT INTO transacoes_horas " +
    ...
    public Optional<TransacaoHoras> findById(Long id) {
        final String sql = "SELECT id_transacao, data_referencia, quantidade_horas, justificativa, " +
    ...
    public void update(TransacaoHoras transacao) {
        final String sql = "UPDATE transacoes_horas " +
    ...
    public void deleteById(Long id) {
        final String sql = "DELETE FROM transacoes_horas WHERE id_transacao = ?";
